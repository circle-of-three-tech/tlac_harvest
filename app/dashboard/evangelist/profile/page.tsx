// app/dashboard/evangelist/profile/page.tsx
"use client";
...
export default function EvangelistProfilePage() {
  ...
  useEffect(() => {
    ...
    if (status === "authenticated" && session?.user?.role !== "EVANGELIST") {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="grid gap-6">
          ...
          <div className="bg-white rounded-2xl p-8 border border-white/10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={saving}
                className="w-fit px-8 bg-harvest-500 hover:bg-harvest-400 disabled:opacity-60 text-white font-semibold py-3 rounded-xl transition-all duration-200 shadow-lg shadow-harvest-500/30"
              >
          ...
          <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
            <p className="text-harvest-600 text-sm">
