...
const AddedLeadsModal = ({ user, isOpen, onClose }: AddedLeadsModalProps) => {
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            <div className="flex items-center justify-center h-40">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-harvest-600"></div>
            </div>
          ) : error ? (
            ...
            <div className="text-center py-12">
              <p className="text-slate-500 text-lg">
                No leads added by this evangelist yet.
              </p>
            </div>
          ) : (
            <div className="space-y-3">
              {leads.map((lead) => (
                <div
                  key={lead.id}
                  className="p-4 bg-gray-50 border border-gray-200 rounded-lg hover:bg-harvest-50 transition"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-2 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-slate-700">
                            <span className="badge bg-harvest-100 text-harvest-700 text-xs py-1 px-2 rounded">
...
export default AddedLeadsModal;
